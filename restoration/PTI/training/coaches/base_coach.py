...
from utils.models_utils import load_old_G, toogle_grad
...
class BaseCoach:
    ...
    def calc_loss(
        ...
        loss_stats = 1000 * self.stats_loss(
            generated_sharp_images, org_sharp_images, generated_deg_images, org_deg_images
        )
        loss += loss_stats
        # loss_percep = 0
