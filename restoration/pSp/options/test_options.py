...
class TestOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument("--out_path", type=str, default="results", help="out path")
        self.parser.add_argument(
            "--couple_outputs", action="store_true", help="Whether to also save inputs + outputs side-by-side"
        )
        self.parser.add_argument(
            "--resize_outputs", action="store_true", help="Whether to resize outputs to 256x256 or keep at 1024x1024"
        )
        ...
        self.parser.add_argument("--stylegan_weights", default=None, type=str, help="Stylegan weight path")
        ...
        self.parser.add_argument(
            "--n_outputs_to_generate", type=int, default=5, help="Number of outputs to generate per input image."
        )
