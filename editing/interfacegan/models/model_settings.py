...
MODEL_DIR = "interfacegan/pretrain"
...
MODEL_POOL = {
    ...
    "stylegan_celebahq": {
        "tf_model_path": MODEL_DIR + "/karras2019stylegan-celebahq-1024x1024.pkl",
    ...
    "stylegan_ffhq": {
        ...
        "model_path": "pretrained/strong_aug_wide_range.pkl",
        "gan_type": "stylegan",
        "dataset_name": "ffhq",
        "latent_space_dim": 512,
        "w_space_dim": 512,
...
STYLEGAN_TRUNCATION_PSI = 1  # 1.0 means no truncation
STYLEGAN_TRUNCATION_LAYERS = 8  # 0 means no truncation
STYLEGAN_TRUNCATION_CUTOFF = 8  # 0 means no truncation
