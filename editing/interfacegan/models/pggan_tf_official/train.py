...
class TrainingSchedule:
    def __init__(
        ...
        tick_kimg_dict={4: 160, 8: 140, 16: 120, 32: 100, 64: 80, 128: 60, 256: 40, 512: 20, 1024: 10},
...
def train_progressive_gan(
    ...
    misc.save_image_grid(
        grid_reals, os.path.join(result_subdir, "reals.png"), drange=training_set.dynamic_range, grid_size=grid_size
    )
    misc.save_image_grid(
        grid_fakes, os.path.join(result_subdir, "fakes%06d.png" % 0), drange=drange_net, grid_size=grid_size
    )
    ...
    while cur_nimg < total_kimg * 1000:
        ...
        if cur_nimg >= tick_start_nimg + sched.tick_kimg * 1000 or done:
            ...
            if cur_tick % network_snapshot_ticks == 0 or done:
                misc.save_pkl(
                    (G, D, Gs), os.path.join(result_subdir, "network-snapshot-%06d.pkl" % (cur_nimg // 1000))
                )
