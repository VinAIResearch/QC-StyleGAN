...
class Network:
    ...
    def _init_graph(self) -> None:
        ...
        with tfutil.absolute_variable_scope(self.scope, reuse=tf.AUTO_REUSE), tfutil.absolute_name_scope(
            self.scope
    ...
    def run(
        ...
        **dynamic_kwargs
        ...
        out_arrays = [
            np.empty([num_items] + tfutil.shape_to_list(expr.shape)[1:], expr.dtype.name) for expr in out_expr
        ]
